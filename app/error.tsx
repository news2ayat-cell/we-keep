...
export default function GlobalError({
  ...
  return (
    <html>
      <body className="min-h-screen bg-[radial-gradient(circle_at_top,_#dbeafe,_#eef2ff_35%,_#f8fafc_70%)] px-4 py-6 sm:px-6 sm:py-8">
        <main className="mx-auto flex max-w-2xl flex-col items-center rounded-[32px] border border-white/60 bg-white/80 p-8 text-center shadow-2xl backdrop-blur-xl sm:p-10">
